    ...
    <section className="max-w-5xl space-y-12">
      <section className="space-y-6">
        <div className="space-y-3">
          <p className="text-sm font-medium text-muted-foreground">Cloudini</p>
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
            Write code. Summon a serverless app.
          </h1>
          <p className="max-w-3xl text-base leading-7 text-muted-foreground sm:text-lg">
            Cloudini is a framework and CLI for generating a serverless
            application and its infrastructure from structured application code.
          </p>
        </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-4 rounded-xl border p-6">
          ...
          <p className="text-muted-foreground">
            Cloudini aims to turn structured application code into a predictable
            serverless backend and the infrastructure required to run it.
          </p>
          <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
            ...
            <li>Support major cloud providers such as AWS, Azure, and GCP.</li>
            <li>
              Work alongside modern frontend frameworks such as React, Vue, and
              Angular.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4 rounded-xl border p-6">
          ...
          <p className="text-muted-foreground">
            Cloudini is in early development. The MVP is focused on delivering a
            strong first version of Cloudini itself—not on creating limited or
            throwaway applications.
          </p>
          <p className="text-muted-foreground">
            The goal is for the MVP of Cloudini to generate real, high-quality
            serverless applications with a predictable and practical set of core
            capabilities.
          </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <article className="rounded-xl border p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              ...
              code to cloud infrastructure in a consistent and predictable way.
            </p>
          </article>
          ...
          <article className="rounded-xl border p-5">
            <h3 className="text-base font-semibold">Static frontend hosting</h3>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
